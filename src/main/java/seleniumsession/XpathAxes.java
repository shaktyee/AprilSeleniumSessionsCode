...
//		String wicketTakerDetails = driver.findElement(By.xpath("//span[text()='Shafali Verma']/ancestor::td/following-sibling::td"))
//											.getText();
//		System.out.println(wicketTakerDetails);
...
//		}
	...
	public static String getWicketTakerName(String playerName) {
		return driver.findElement(By.xpath("//span[text()='"+playerName+"']/ancestor::td/following-sibling::td"))
				.getText();
	}
	...
	public static List<String> getPlayerScoreCardList(String playerName) {
		...
		List<WebElement> scoreList = driver.findElements(By.xpath("//span[text()='"+playerName+"']/ancestor::td/following-sibling::td"));
